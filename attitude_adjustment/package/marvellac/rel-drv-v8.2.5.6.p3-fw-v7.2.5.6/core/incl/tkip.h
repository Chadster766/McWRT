...
void ComputeEAPOL_MIC(WL_PRIV *wlpptr,UINT8 *data, UINT16 data_length,
					  UINT8 *MIC_Key, UINT8 MIC_Key_length,
					  UINT8 *computed_MIC, UINT8* RsnIEBuf);
void genetate_PTK(WL_PRIV *wlpptr,UINT8 *PMK, IEEEtypes_MacAddr_t *pAddr1,
...
void MicErrTimerExpCb(WL_PRIV *wlpptr);
...
#define WEU_MIC_KEY_Hi WEU_REG_ADDR(0x108)  
