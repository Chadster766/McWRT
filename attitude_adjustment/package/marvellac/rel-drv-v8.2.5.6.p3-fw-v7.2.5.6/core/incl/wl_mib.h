...
typedef struct MIB_StaCfg_s
{
	...
	UINT8 NoAckMode;
	UINT8 WSMQoSOptImpl; //If WSM is supported.  /* QOS_WSM_FEATURE */
	...
	UINT8 mib_preAmble;
	UINT32 sta11hMode ;  /* IEEE80211_DH */
	UINT32 wpawpa2Mode ; /* WPS_CLIENT */
}
MIB_STA_CFG;
...
typedef struct MIB_802DOT11_s
{
	...
	MIB_SPECTRUM_MGMT	*SpectrumMagament;  /* IEEE80211H */
	/* BRS_SUPPORT */
