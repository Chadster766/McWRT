...
#ifndef bzero
#define bzero(a, l) WL_MEMSET(a, 0, l)
#endif

#ifndef bcopy
#define bcopy(s, d, l) WL_MEMCPY(d, s, l)
#endif

#ifndef SIZE_MAXIMUM
#define SIZE_MAXIMUM 1024
#endif
...
#define WLXMIT_PARAM_FLAGS_EAPOL	(1<<0)
#define WLXMIT_PARAM_FLAGS_BCAST	(1<<1)
#define WLXMIT_PARAM_DONOT_FREE		(1<<2)
