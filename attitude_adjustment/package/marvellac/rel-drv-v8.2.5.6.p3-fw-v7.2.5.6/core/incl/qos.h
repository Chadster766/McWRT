...
* PDL:      * 
*****************************************************************************/
//UINT32 QoS_UpdateEDCAParameters(WL_PRIV *wlpptr);
extern UINT16 Qos_UpdateWSMQosCapElem(WL_PRIV *wlpptr,UINT8 *pBcnBuf);
extern UINT16 QoS_AppendWMEParamElem(WL_PRIV *wlpptr,UINT8 *pBcnBuf);
extern void QoS_ReAppendWMEInfoElem(WL_PRIV *wlpptr);


extern BOOLEAN GetEther_QueueData(UINT8 **frame, int **pktFilterSel, int *len);

extern UINT16 ProcessADDTSRequest(WL_PRIV *wlpptr,IEEEtypes_ADDTS_Req_t *AddTSReq_p,
								  IEEEtypes_MacAddr_t *pStaAddr, UINT16 Aid,
								  UINT32 *TspecIndx, UINT8);

extern UINT32 ClearQoSDB(IEEEtypes_MacAddr_t *);
extern Status_e ProcessDELTSRequest(WL_PRIV *wlpptr,IEEEtypes_MacAddr_t *, UINT32 );
extern UINT8 ProcessADDTSRequestSchedule(IEEEtypes_ADDTS_Rsp_t *, UINT32);
void SendDelBA(WL_PRIV *wlpptr,IEEEtypes_MacAddr_t , UINT8);
...
void SendAddBAReq(WL_PRIV *wlpptr,IEEEtypes_MacAddr_t StaAddrA, UINT8 tsid,
				  IEEEtypes_QoS_BA_Policy_e BaPolicy, UINT32 SeqNo, UINT8 DialogToken);
extern void SendDelBA2(WL_PRIV *wlpptr,IEEEtypes_MacAddr_t StaAddr, UINT8 tsid);
extern UINT16 AddWMEParam_IE(WME_param_elem_t * pNextElement);		   
extern void InitWMEParamElem(WL_PRIV *wlpptr);
