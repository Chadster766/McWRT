...
#define IEEEtypes_CAP_INFO_SPECTRUM_MGMT    0x0100  /* IEEE80211H */
...
/** currently one company use this oui for High thruput element 51 **/
...
typedef union
{
	IEEEtypes_Sched_Element_t   Schedule; 
...
typedef  struct IEEEtypes_ScanCfrm_t
{
	...
	IEEEtypes_COUNTRY_IE_t  Country;  /* IEEE80211H */
...
typedef  struct IEEEtypes_AssocCmd_t
{
	...
	IEEEtypes_CapInfo_t CapInfo;
	IEEEtypes_ListenInterval_t ListenInterval;
	IEEEtypes_SupportedChannelElement_t SupportedChannel;  /* IEEE80211H */
...
typedef  struct 
{
    ...
    UINT32 TxBFCapabilities; /* EXBF_SUPPORT */
    UINT32 vht_MaxRxMcs;							
    UINT32 vht_cap;					
...
{      
	...
	{       
		...
		IEEEtypes_BWCtl_t BWCtl; /* COEXIST_20_40_SUPPORT */
