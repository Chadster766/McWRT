...
static int ap8x_stat_seq_show(struct seq_file *seq, void *p)
{
	...
	seq_printf(seq, "rx_weakiv_count..................%10u\n", (int)((struct wlprivate_data *)(wlpptr->wlpd_p))->privStats.weakiv_count );
	...
	seq_printf(seq, "tx_headerroom_errors.............%10u\n", (int)((struct wlprivate_data *)(wlpptr->wlpd_p))->privStats.skbheaderroomfailure );
	seq_printf(seq, "tx_tsoframe_counts...............%10u\n", (int)((struct wlprivate_data *)(wlpptr->wlpd_p))->privStats.tsoframecount );
	...
	if (page) {
		if (wlFwGetHwStats(wlpptr, page) > PAGE_SIZE)
			BUG();
