...
#define PFU_DESCRIPTOR_FLAG_SOP BIT(0)
#define PFU_DESCRIPTOR_FLAG_EOP BIT(1)
#define PFU_DESCRIPTOR_FLAG_SOAM BIT(6)
#define PFU_DESCRIPTOR_FLAG_SW_AMSDU BIT(8)
#define PFU_DESCRIPTOR_FLAG_SW_FISRT_AMSDU BIT(9)
