...
3. Navigate to the Connectivity tab on the left side.
4. Select choose file in the 'Manual:' tab.
5. Choose the image to load, probably located in your download folder. The default filename for McWRT is: 'openwrt-armadaxp--jffs2-128k.img)'.
6. Click start.
...
5. Click 'flash image'.
6. The router will reboot, and you are now able to configure your router.
7. The default router login page is 192.168.1.1.

#### Notes

1. The default image file can be downloaded on: <http://cache-www.belkin.com/support/dl/FW_WRT1900AC_1.1.10.167514_prod.img>
